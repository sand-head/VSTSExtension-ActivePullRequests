...
> {
    ...
    return (
      <div>
        <Panel
          ...
          description={
            'Modify settings for the All Active Pull Requests extension. Settings only affect your user account for this project.'
          }
          footerButtonProps={[
            {
              text: 'Save Changes',
        ...
        >
          <div className="flex-grow rhythm-vertical-8">
            <div className="flex-column">
              <div
                className={`font-size-l font-weight-semibold flex-noshrink flex-grow ${styles.settingTitle}`}
              >
                Column Display
              </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              <div className="font-size-mm font-weight-semibold flex-noshrink flex-grow">
                Author
              </div>
              <Toggle
                offText={'Hide'}
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.author);
                }}
              />
            </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              ...
              <Toggle
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.created);
                }}
              />
            </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              ...
              <Toggle
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.details);
                }}
              />
            </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              ...
              <Toggle
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.repository);
                }}
              />
            </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              ...
              <Toggle
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.comments);
                }}
              />
            </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              ...
              <Toggle
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.buildStatus);
                }}
              />
            </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              ...
              <Toggle
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.myVote);
                }}
              />
            </div>
            ...
            <div className={`flex-row ${styles.settingItem}`}>
              ...
              <Toggle
                ...
                onChange={(event, value) => {
                  this.updateSetting(value, SettingsColumn.reviewers);
                }}
              />
            </div>
          </div>
  ...
  private saveSettings() {
    this.state
      .dataManager!.setValue<string>(
        `${this.state.projectName}-extension-settings`,
